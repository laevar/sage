...
{\color{blue}{Einführung in Sage (Mathematische Anwendersysteme) (WS 2014/2015)}}
...
\begin{itemize}
\item Sage ist in Version 6.4.1 installiert
\item Sage nutzen: 
\begin{itemize}
...
\begin{itemize}
\item Blockveranstaltung vom  23.2-6.3.2015
...
\end{itemize}
\item \alert{Praktikum:} von 11:00 bis 17:00 Uhr im WAP-Raum der NAM (Lotzestr. 16 -18, EG neben Geschäftszimmer).
\item \alert{Klausur 1:} 13.3.2015; 10:00 - 11:30; HS1/Maximum.
\item \alert{Klausur 2:} 27.3.2015; 10:00 - 11:30; HS1.
\end{itemize}
\end{frame}

\begin{frame}{Inhalt der Vorlesung}
\alert{Ziel:} Wiederholung des Stoffs aus Diff 1 und AGLA 1 mittels der Methoden der Computeralgebra und der numerischen Rechnung.
\begin{description}
...
\item [5. Tag] Objektorientierung, Datencontainer, Lineare Abbildungen, Eigenwert und Eigenvektoren
\item [6. Tag] Folgen, Reihen, Vertiefung Schleifen
\item [7. Tag] Funktionen, Grenzwerte, Funktionenfolgen, Grafiken
\item [8. Tag] Differentation, Taylorsche Formel, Integration
\item [9. Tag] Strings, Dekoratoren, interaktive Grafiken
\item [10. Tag] GeoGebra, Komplexe Beispiele
\end{description}
\end{frame}
...
\alert{Schwächen}
\begin{itemize}
\item Befehlsumfang insgesamt nicht so leistungsfähig/ausgefeilt wie bei Maple, Mathematica oder Matlab.
...
\item Performance i.a. nicht gut, aber signifikant verbesserbar (Cython)
\end{itemize}
\end{frame}
...
\begin{block}{Anmerkung}
  Programmieren lernt man am Rechner durch Übung (Wie man Mathematik mit Zettel und Stift lernt)! nehmt bitte die Möglichkeiten der Übung und des Praktikums wahr!
\end{block}
\end{frame}
\end{document}
