...
\begin{frame}[fragile]{\isage{while}-Schleifen}
Eine andere Form einer Schleife ist 
\begin{sagein}
while <expression> : <block>
\end{sagein}
Diese wiederholt \isage{<block>} solange wie die \isage{<expression>} als 
