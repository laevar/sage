...
\begin{itemize}
\item Die Funktionen \verb+<parametric_>plot()+ und \verb+<parametric_>plot3d()+ dienen
...
mit dem Befehl \verb+animate()+ lassen sich einfach Animationen erstellen. Dies funktioniert nur für zweidimensionale plots.
