...
\verb+a.expand()+ und \verb+a.expand_trig()+}. \\
\begin{sage}
>> expand((x+2)^4)
\end{sage}
\begin{sage}
...
\begin{frame}[fragile]{simplify\_rational()}
Durch {\color{blue} \verb+f.simplify_rational()+} wird eine 'Normalform' eines
...
\begin{frame}[fragile]{Beispiele - simplify\_trig()}
\begin{sage}
>> (tan(x)).simplify_trig()
\end{sage}
\begin{sage}
