...
\hline
\verb+integer+ & ganze Zahlen & \verb+-3,0,100+\\
\verb+rational+ & rationale Zahlen & \verb+7/11+\\
...
\begin{itemize}
\item \verb+solve+ ist der Befehl zum Lösen von Gleichungen und Gleichungssystemen.
...
\item Mit \verb+multiplicities=True+ erhält man alle möglichen Lösungen.
\item {\color{blue}\verb+solution_dict=true+} gibt die Lösung als Dictonary zurück (Dazu später mehr)
\end{itemize}
\end{frame}
