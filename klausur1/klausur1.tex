...
\begin{aufg}{2}
Schreiben sie eine Funktion mit \isage{def}, die folgendes berechnet. 
...
\item Berechnen Sie die Extremstellen und stellen Sie fest ob es sich um
  Maxima oder Minima handelt.  Geben Sie jeweils auch den Funktionswert mit aus. 
\end{itemize}
\end{aufg}
