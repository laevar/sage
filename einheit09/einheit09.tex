...
\item Beim interaktiven Gebrauch von Sage sind alle Variablen \alert{global}, 
...
ändern.
\item Daneben gibt es aber auch \alert{lokale Variablen}, die nur
innerhalb einer Prozedur/Funktion gültig sind. Nach Beenden der Prozedur werden
