...
\begin{aufg}
Bestimmen Sie die alle Teilmengen von $\{ 1,2,3,4,5,6 \}$,
  die $1$ und $4$ enthalten.
\end{aufg}
...
$M3=\lbrace1,2,a,b,f,g\rbrace$. 
  ...
  \item
    Bestimmen Sie alle Teilmengen von $M1$, die sowohl $2$ als auch $b$
    enthalten. 
  \end{enumerate}
\end{aufg}
...
\begin{aufg}
Nach \isage{x = (10^50/3.0).n(digits=100)} sind nur die ersten Dezimalstellen in
...
f(0)
\end{sagein}
Erklären Sie den Fehler. Wie können Sie die Funktion \isage{f(x)} anpassen, damit der
