...
\item Der Befehl \isage{select} funktioniert auch für Mengen, Tabellen oder Ausdrücke.
\end{itemize}
\end{frame}
...
Objekte sein. 
\item Dictonaries haben den Typ \isage{dict}.
\item  Dictonaries sind Datenstrukturen, die für das Speichern großer
...
\item der \isage{key} ist eindeutig
\end{itemize}
\end{frame}
...
\end{sage}
\item Erzeugen eines leeren Dictonaries
\begin{sagein}
T1 = {}; T1
\end{sagein}
\begin{sage}
