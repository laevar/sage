...
\begin{aufg}
  ...
  \begin{enumerate}
  \item
    Erstellen Sie diese beiden Listen mit Hilfe des \isage{[... for ...]} Konstruktes.
...
\begin{aufg}
Berechnen Sie mit Hilfe einer \isage{for}-Schleife die ersten 10 Glieder der Folge
...
\begin{aufg}
Schreiben Sie eine Funktion \isage{fak}, die die Fakultät 
\[ a!= \prod_{i=1}^a i\]
